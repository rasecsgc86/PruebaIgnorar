...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Por favor verifique la información.",
		email: "Por favor indique una dirección de correo válida.",
		url: "Por favor indique una URL válida.",
		date: "Por favor ingrese una fecha válida.",
		dateISO: "Por favor ingrese una fecha válida ( ISO ).",
		number: "Por favor ingrese un número válido.",
		digits: "Por favor ingrese sólo dígitos.",
		creditcard: "Por favor ingrese un número válido de su tarjeta de crédito.",
