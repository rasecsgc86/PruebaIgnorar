...
define(['modules/app', 'services/requestService', 'services/mappingService'],
    function (app) {
         ...
         * 
         * Modoficacion INDRA FJQP --- Encontrack, Emisión Multiple
         * 
         */
        ...
        [
            ...
            function ($scope,
                ...
                $scope.$parent.CabeceraCotizacionHeredada = ''; /* Modificacion INDRA FJQP --- Encontrack, Emisión Multiple*/
                $scope.$parent.CotizarModelHeredada = ''; /* Modificacion INDRA FJQP --- Encontrack, Emisión Multiple*/
                ...
                $scope.confirmedEncontrack = false; /* Modificacion INDRA FJQP --- Encontrack, Emisión Multiple*/
                ...
                $rootScope.submitCot = function () {
                    ...
                    if ($scope.requeridosVehiculoList.length !== 0 ||
                        ...
                        if ($scope.ProductoFlex && !$scope.$parent.hayDatosPanel) {
                            ...
                            /* Modificacion INDRA FJQP --- Encontrack, Emisión Multiple*/
                ...
                /*********************************************************************************************
                 ****             Funcion validar campos "Requeridos" - Datos de Cotización               ****
                 *********************************************************************************************/
                ...
                /* INDRA FJQP Encontrack y Emisión Multiple */
                ...
                function inicializaInformacionGral() {
                    $scope.validacionInformacion = {
                        Cliente: {
                            Nombre: {
                                Label:
                                    "Si, ingresa cualquier campo del área de cotizante debe ingresar los demás datos",
                                Activo: false
                            },
                            RazonSocial: {
                                Label:
                        ...
                        Cotizacion: {
                            ...
                            CodigoPostal: {
                                Label: 'Búsqueda por "Código Postal" o "Colonia"',
                                Activo: false
                            },
                            Estado: {
                                Label: "Estado",
